...
var i = class {
  ...
  constructor(e2, t) {
    ...
    this.options = void 0, this.connection = void 0, this.lastInterruptTimestamp = 0, this.mode = "listening", this.status = "connecting", this.volume = 1, this.currentEventId = 1, this.lastFeedbackEventId = 1, this.canSendFeedback = false, this.endSessionWithDetails = async function(e3) {
      ...
      this.volume = e3;
    }, this.options = e2, this.connection = t, this.options.onConnect({ conversationId: t.conversationId }), this.connection.onMessage(this.onMessage), this.connection.onDisconnect(this.endSessionWithDetails), this.connection.onModeChange((e3) => this.updateMode(e3)), this.updateStatus("connected");
  }
  endSession() {
...
var p = class _p extends r2 {
  ...
  static async create(e2) {
    ...
    try {
      ...
      }), { conversation_id: v2, agent_output_audio_format: f2, user_input_audio_format: w2 } = g2, y2 = c(null != w2 ? w2 : "pcm_16000"), b2 = c(f2);
      return new _p(t, v2, y2, b2);
    } catch (e3) {
      var a2;
...
var m = class _m extends r2 {
  ...
  static async create(n) {
    ...
    if ("conversationToken" in n && n.conversationToken) s = n.conversationToken;
      ...
      try {
        var o3, a2, i2;
        const e2 = (null == (o3 = n.overrides) || null == (o3 = o3.client) ? void 0 : o3.version) || l, t = (null == (a2 = n.overrides) || null == (a2 = a2.client) ? void 0 : a2.source) || "js_sdk", c2 = `${r3 = null != (i2 = n.origin) ? i2 : "https://api.elevenlabs.io", r3.replace(/^wss:\/\//, "https://")}/v1/convai/conversation/token?agent_id=${n.agentId}&source=${t}&version=${e2}`, u3 = await fetch(c2);
        if (!u3.ok) throw new Error(`ElevenLabs API returned ${u3.status} ${u3.statusText}`);
        if (s = (await u3.json()).token, !s) throw new Error("No conversation token received from API");
      } catch (e2) {
    ...
    const u2 = new Room();
    try {
      const e2 = `webrtc-${Date.now()}`, o4 = c("pcm_48000"), a3 = c("pcm_48000"), i3 = new _m(u2, e2, o4, a3, n), r4 = n.livekitUrl || "wss://livekit.rtc.elevenlabs.io";
      await u2.connect(r4, s), await new Promise((e3) => {
        if (i3.isConnected) e3();
        else {
          const n2 = () => {
            u2.off(RoomEvent.Connected, n2), e3();
          };
          u2.on(RoomEvent.Connected, n2);
        }
      }), u2.name && (i3.conversationId = u2.name), await u2.localParticipant.setMicrophoneEnabled(true);
      const l2 = h2(n);
      return i3.debug({ type: d, message: l2 }), await i3.sendMessage(l2), i3;
    } catch (e2) {
      throw await u2.disconnect(), e2;
    }
  }
  setupRoomEventListeners() {
    ...
    this.room.on(RoomEvent.Connected, async function() {
      ...
      t.length > 0 ? t[0].identity.includes("agent") && e2.updateMode("speaking") : e2.updateMode("listening");
    });
  }
  close() {
...
var C = class _C {
  static async create({ sampleRate: e2, format: t, preferHeadphonesForIosDevices: n }) {
    let s = null, a2 = null;
    try {
      const i3 = { sampleRate: { ideal: e2 }, echoCancellation: true, noiseSuppression: true };
      if (v() && n) {
        ...
        e3 && (i3.deviceId = { ideal: e3.deviceId });
      }
      const r4 = navigator.mediaDevices.getSupportedConstraints().sampleRate;
      s = new window.AudioContext(r4 ? { sampleRate: e2 } : {});
      const c2 = s.createAnalyser();
      r4 || await s.audioWorklet.addModule("https://cdn.jsdelivr.net/npm/@alexanderolsen/libsamplerate-js@2.1.2/dist/libsamplerate.worklet.js"), await M(s.audioWorklet);
      const l2 = o2({ voiceIsolation: true }, i3);
      a2 = await navigator.mediaDevices.getUserMedia({ audio: l2 });
      const u2 = s.createMediaStreamSource(a2), d2 = new AudioWorkletNode(s, "raw-audio-processor");
      return d2.port.postMessage({ type: "setFormat", format: t, sampleRate: e2 }), u2.connect(c2), c2.connect(d2), await s.resume(), new _C(s, c2, d2, a2);
    } catch (e3) {
      var i2, r3;
      throw null == (i2 = a2) || i2.getTracks().forEach((e4) => e4.stop()), null == (r3 = s) || r3.close(), e3;
    }
  }
  constructor(e2, t, n, s) {
...
var F = class _F extends i {
  static async startSession(e2) {
    ...
    try {
      var u2;
      return c2 = await navigator.mediaDevices.getUserMedia({ audio: true }), await f(n.connectionDelay), a2 = await g(e2), [s, r3] = await Promise.all([C.create(o2({}, a2.inputFormat, { preferHeadphonesForIosDevices: e2.preferHeadphonesForIosDevices })), I.create(a2.outputFormat)]), null == (u2 = c2) || u2.getTracks().forEach((e3) => e3.stop()), c2 = null, new _F(n, a2, s, r3, l2);
    } catch (e3) {
      var d2, h3, p2, m2;
  ...
  constructor(e2, t, n, s, o3) {
    super(e2, t), this.input = void 0, this.output = void 0, this.wakeLock = void 0, this.inputFrequencyData = void 0, this.outputFrequencyData = void 0, this.onInputWorkletMessage = (e3) => {
      ...
      this.output.gain.gain.value = this.volume, this.output.worklet.port.postMessage({ type: "clearInterrupted" }), this.output.worklet.port.postMessage({ type: "buffer", buffer: b(e3) });
    }, this.fadeOutAudio = () => {
  ...
  setMicMuted(e2) {
    this.connection instanceof m ? this.connection.setMicMuted(e2) : this.input.setMuted(e2);
  }
  getInputByteFrequencyData() {
